  ...
  return (
    <div className="dialog-overlay" role="dialog" aria-modal="true" aria-labelledby="welcome-title">
      <div className="dialog">
        <span className="dialog__icon">🖥️</span>
        <h2 className="dialog__title" id="welcome-title">
          Welcome to the RDM Scavenger Hunt
        </h2>

        <div className="dialog__body">
          <p style={{ marginBottom: '10px', fontFamily: 'var(--font-pixel)', fontSize: '7px', lineHeight: 2 }}>
          ...
          <ul style={{ fontFamily: 'var(--font-pixel)', fontSize: '7px', lineHeight: 2.2, paddingLeft: '16px', marginBottom: '10px' }}>
          ...
          <p style={{ fontFamily: 'var(--font-pixel)', fontSize: '7px', lineHeight: 2 }}>
